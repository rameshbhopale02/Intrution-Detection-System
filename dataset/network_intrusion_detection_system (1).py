...
Original file is located at
    https://colab.research.google.com/drive/13GUM-WKvUWfl7jCNMnmFiD3S5KK1vTVW
...
result = numeric_data.groupby(train['attack_class']).mean().T
...
X = X.dropna()
train_new = train_new[train_new['attack_class'].notna()]
...
# Define the base model and the BaggingClassifier
